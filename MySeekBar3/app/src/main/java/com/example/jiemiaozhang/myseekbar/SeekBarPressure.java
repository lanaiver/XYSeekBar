...
public class SeekBarPressure extends View {
    ...
    public SeekBarPressure(Context context, AttributeSet attrs, int defStyle) {
        ...
        notScrollBarBg = getResources().getDrawable(R.drawable.seekbarpressure_bg_progress, null);
        hasScrollBarBg = getResources().getDrawable(R.drawable.seekbarpressure_bg_normal, null);
        mThumbLow = getResources().getDrawable(R.drawable.seekbarpressure_thumb, null);
        mThumbHigh = getResources().getDrawable(R.drawable.seekbarpressure_thumb, null);
